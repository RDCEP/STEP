 ...
 *[Basemap](matplotlib.org/basemap) is necessary when using the example function `plot_with_map` found in the [Tutorial](https://github.com/relttira/STEP/wiki/Tutorial). Additionally, the results of the package can be plotted using your visualization library of choice.*
## Usage

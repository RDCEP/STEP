 ...
 *[Basemap](matplotlib.org/basemap) is necessary when using the example function in `plot_with_map` found in the [Tutorial](https://github.com/relttira/STEP/wiki/Tutorial). Additionally, you can plot the results of the package using the visualization library of your choice.*
## Usage
